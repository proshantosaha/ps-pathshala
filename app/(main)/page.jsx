...
import banner from "../../public/assets/stock.jpg";
  ...
  return (
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 grainy">
        <div className="container flex max-w-[100rem] flex-col-2  items-center justify-evenly gap-4 text-center relative isolate">
          <div className="flex flex-col max-w-[50rem]">
            ...
            >
              <div
                ...
                className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#808fff] to-[#89effc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              />
            </div>
          ...
          <div className="flex flex-col max-w-[50rem]">
            <Image width={300} height={300} src={banner} alt="logo" />
          </div>
        </div>
      </section>
      {/* Categories Section */}
